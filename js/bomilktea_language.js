const translations = {
    ...
    'ja': {
        ...
        'about-title': 'ボーミルクティーについて',
        'about-description': 'タピオカ、レモンティー、コーヒー、ヨーグルト、塗り絵、揚げ物などを専門に提供しています。価格はお手頃で、飲み物や軽食のメニューも多彩です。<br><br>お子様は無料のミニボールプールで自由に遊べます。ご両親は食べ物や飲み物を楽しみながら、お子様を心配することなくリラックスできます。特に、お子様の創造力を引き出すために、非常にお得な価格で絵付け体験も提供しています。1階は温かみのある豪華な内装で、2階は広々として快適な空間です。',
        'about-footer': 'ボーミルクティーにご来店いただき、素晴らしい体験をしていただけるよう努力しています。皆様のご来店をお待ちしております！'
    },
    'en': {
        'title': 'BO MILK TEA',
